...
function prebuild_gcc() {
  ...
  curl -o "gcc-12-arm.diff" https://raw.githubusercontent.com/Homebrew/formula-patches/1d184289/gcc/gcc-12.2.0-arm.diff
  try patch --verbose --forward -p1 < gcc-12-arm.diff
  touch .patched
}
